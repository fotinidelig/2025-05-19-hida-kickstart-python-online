...
humandate: "Mai 19-20, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 13:00 pm CEST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2025-05-19      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2025-05-20        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Riccardo Massei", "Madhu Nagathihalikantharaju"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Fotini Deligiannaki", "Riccardo Massei", "Madhu Nagathihalikantharaju"] # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: [" hida-courses@helmholtz.de", "riccardo.massei@ufz.de", "madhu.nagathihalikantharaju@mdc-berlin.de", "fotini.deligiannaki@dlr.de"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.carpentries.org/2025-05-19-hida-kickstart-python-online # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<p id="registration">
  <strong>Registration & Survey:</strong> <a href="https://events.hifis.net/event/2097/">https://events.hifis.net/event/2097/</a>
</p>
...
<p>A survey will open on the second day of the workshop at the bottom of the course registration website. We appreciate it if you take the survey as it is essential for improving our HIDA workshops.</p>
